...
def feedforward_neuralnetwork(X, Y, layers_dims, learning_rate, num_iterations, print_cost):#lr was 0.009
...
if __name__ == '__main__':
    ...
    # Learned parameters
	parameters = feedforward_neuralnetwork(train_x, train_y, layers_dims, learning_rate, num_iterations, print_cost)
